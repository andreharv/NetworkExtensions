    ...
    public class CustomCitizenAI : CitizenAI
    {
        ...
        protected new bool StartPathFind(ushort instanceID, ref CitizenInstance citizenData, Vector3 startPos, Vector3 endPos, VehicleInfo vehicleInfo)
        {
            ...
            if (parkedVehicle != 0)
            {
                ...
                CustomPathManager.FindPathPosition(ExtendedVehicleType.PassengerCar, position, ItemClass.Service.Road, NetInfo.LaneType.Vehicle | NetInfo.LaneType.TransportVehicle, VehicleInfo.VehicleType.Car, false, false, 32f, out vehiclePosition);
            }
