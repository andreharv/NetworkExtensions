    ...
    public static partial class HighwayModels
    {
        public static void Setup28mMesh(this NetInfo info, NetInfoVersion version)
        {
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                segments0.SetMeshes
                    (@"Highways\Common\Meshes\28m\Ground.obj",
                     @"Highways\Common\Meshes\28m\Ground_LOD.obj");

                nodes0.SetMeshes
                    (@"Highways\Common\Meshes\28m\Ground_Node.obj",
                     @"Highways\Common\Meshes\28m\Ground_Node_LOD.obj");

                nodes1.SetMeshes
                    (@"Highways\Common\Meshes\28m\Ground_Trans.obj",
                     @"Highways\Common\Meshes\28m\Ground_Trans_LOD.obj");
            ...
            else if (version == NetInfoVersion.Tunnel)
            {
                ...
                segments0.SetMeshes
                    (@"Highways\Common\Meshes\28m\Tunnel_Gray.obj",
                    @"Highways\Common\Meshes\28m\Ground_LOD.obj");
                segments1.SetMeshes
                    (@"Highways\Common\Meshes\28m\Tunnel.obj",
                    @"Highways\Common\Meshes\28m\Tunnel_LOD.obj");
                nodes0.SetMeshes
                     (@"Highways\Common\Meshes\28m\Tunnel_Node_Gray.obj",
                    @"Highways\Common\Meshes\28m\Ground_Node_LOD.obj");
                nodes1.SetMeshes
                    (@"Highways\Common\Meshes\28m\Tunnel_Node.obj",
                     @"Highways\Common\Meshes\28m\Tunnel_Node_LOD.obj");
                // nodes2.SetMeshes
                //    (@"Highways\Common\Meshes\28m\Tunnel.obj",
                //    @"Highways\Common\Meshes\28m\Ground_LOD.obj");
