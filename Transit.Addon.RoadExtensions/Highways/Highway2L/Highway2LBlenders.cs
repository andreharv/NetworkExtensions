...
{
    public static class Highway2LBlenders
    {
        ...
        public static IImageBlender GetSegmentMainTex()
        {
            return ImageBlender
        ...
        public static IImageBlender GetSegmentAPRMap()
        {
            return ImageBlender
        ...
        public static IImageBlender GetNodeMainTex()
        {
            return ImageBlender
                .FromBaseFile(@"Roads\Common\Textures\MainTex\Segment__MainTex.png")
        ...
        public static IImageBlender GetNodeAPRMap()
        {
            return ImageBlender
                .FromBaseFile(@"Roads\Common\Textures\APRMap\Segment__APRMap.png")
