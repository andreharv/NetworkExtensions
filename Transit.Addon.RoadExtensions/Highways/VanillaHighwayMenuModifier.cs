    ...
    public class VanillaHighwayMenuModifier : IModulePart, INetInfoModifier
    {
        ...
        public void ModifyExistingNetInfo()
        {
            ...
            if (highwayRampInfo != null)
            {
                ...
                var thumbnails = AssetManager.instance.GetThumbnails(NetInfos.Vanilla.HIGHWAY_RAMP, @"Highways\HighwayRamp\thumbnails.png");
            ...
            if (highway3L != null)
            {
                ...
                var thumbnails = AssetManager.instance.GetThumbnails(NetInfos.Vanilla.HIGHWAY_3L, @"Highways\Highway3L\thumbnails.png");
            ...
            if (highway3LBarrier != null)
            {
                ...
                var thumbnails = AssetManager.instance.GetThumbnails(NetInfos.Vanilla.HIGHWAY_3L_BARRIER, @"Highways\Highway3LBarrier\thumbnails.png");
