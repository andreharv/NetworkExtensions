                    ...
                    for (var i = 0; i < info.m_segments.Length; i++)
                    {
                        if (info.m_segments[i].m_mesh.name.Contains("Ground_Pavement"))
                        {
                            info.m_segments[i].SetTextures(
                                new TextureSet
                                    (@"PublicTransport\Rail\Rail1L\Textures\Ground_Segment_Pavement__MainTex.png",
                                    @"PublicTransport\Rail\Rail1L\Textures\Ground_Segment_Pavement__AlphaMap.png"));
                        }
                    }
                    break;
                ...
                case NetInfoVersion.Slope:
                    for (var i = 0; i < info.m_segments.Length; i++)
                    {
                        if (info.m_segments[i].m_mesh.name.Contains("slope"))
                        {
                            info.m_segments[i].SetTextures(
                                new TextureSet
                                    (@"PublicTransport\Rail\Rail1L\Textures\Slope_Segment__MainTex.png",
                                    @"PublicTransport\Rail\Rail1L\Textures\Slope_Segment__AlphaMap.png"),
                                new LODTextureSet
                                    (@"PublicTransport\Rail\Rail1L\Textures\Slope_Cover_LOD__MainTex.png",
                                    @"PublicTransport\Rail\Rail1L\Textures\Slope_Cover_LOD__AlphaMap.png",
                                    @"PublicTransport\Rail\Rail1L\Textures\Slope_Cover_LOD__XYSMap.png"));
                        }
                ...
                case NetInfoVersion.Tunnel:
                    {
                        info.SetAllSegmentsTexture(
                            new TextureSet
                                (@"PublicTransport\Rail\Rail1L\Textures\Tunnel_Segment__MainTex.png",
                                @"PublicTransport\Rail\Rail1L\Textures\Tunnel_Segment__AlphaMap.png"));
                        info.SetAllNodesTexture(
                            new TextureSet
                                (@"PublicTransport\Rail\Rail1L\Textures\Tunnel_Segment__MainTex.png",
                                @"PublicTransport\Rail\Rail1L\Textures\Tunnel_Segment__AlphaMap.png"));
