...
using TransitPlus.Addon.RoadExtensions.Roads.TinyRoads.Oneway1LBicycle;
using TransitPlus.Addon.RoadExtensions.Roads.TinyRoads.Oneway1LParkingBicycle;
using TransitPlus.Addon.RoadExtensions.Roads.TinyRoads.Oneway2L;
...
namespace TransitPlus.Addon.RoadExtensions
{
    public partial class RExPlusModule
    {
        ...
        {
            _container = new GameObject(RExPlusOBJECT_NAME);
