...
namespace Transit.Addon.RoadExtensions.Roads.Common
{
    ...
    {
        public static NetInfo Setup8m1mSWMesh(this NetInfo info, NetInfoVersion version, LanesLayoutStyle laneStyle = LanesLayoutStyle.Symmetrical)
        {
            switch (version)
            {
                case NetInfoVersion.Ground:
                    {
                        ...
                        segments0
                            .SetFlagsDefault()
                            .SetMeshes
                            (@"Roads\Common\Meshes\8m\1mSW\Ground.obj",
                             @"Roads\Common\Meshes\8m\1mSW\Ground_LOD.obj");

                        nodes0
                            .SetFlags(NetNode.Flags.None, NetNode.Flags.Transition)
                            .SetMeshes
                            (@"Roads\Common\Meshes\8m\1mSW\Ground_Node.obj",
                             @"Roads\Common\Meshes\8m\1mSW\Ground_Node_LOD.obj");

                        nodes1
                            .SetFlags(NetNode.Flags.Transition, NetNode.Flags.None)
                            .SetMeshes
                            (@"Roads\Common\Meshes\8m\1mSW\Ground_Trans.obj",
                             @"Roads\Common\Meshes\8m\1mSW\Ground_Node_LOD.obj");
