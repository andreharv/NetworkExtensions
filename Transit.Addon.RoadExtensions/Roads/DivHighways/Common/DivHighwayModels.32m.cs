        ...
        public static void Setup32mGrassMesh(this NetInfo info, NetInfoVersion version)
        {
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                nodes3
                    .SetFlags(NetNode.Flags.Transition, NetNode.Flags.None)
                    .SetMeshes
                        (@"Roads\DivHighways\Common\Meshes\32mGrass\Ground_Trans_Grass.obj");

                nodes2.m_emptyTransparent = true;
                nodes2.m_directConnect = true;
                nodes2.m_requireSurfaceMaps = true;
                nodes2.m_connectGroup = NetInfo.ConnectGroup.NarrowTram;

                nodes3.m_emptyTransparent = true;
                nodes3.m_directConnect = true;
                nodes3.m_requireSurfaceMaps = true;
                nodes3.m_connectGroup = NetInfo.ConnectGroup.NarrowTram;
