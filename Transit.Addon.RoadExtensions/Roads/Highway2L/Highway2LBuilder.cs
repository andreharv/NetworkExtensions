...
{
    public class Highway2LBuilder : NetInfoBuilderBase, INetInfoBuilder
    {
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            switch (version)
            {
                case NetInfoVersion.Ground:
                    info.SetAllSegmentsTexture(
                        new TexturesSet(
                            @"Roads\Highway2L\Textures\Ground_Elevated_Segment__MainTex.png",
                            @"Roads\Highway2L\Textures\Ground_Segment__APRMap.png"),
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Ground_SegmentLOD__MainTex.png",
                            @"Roads\Highway2L\Textures\Ground_SegmentLOD__APRMap.png",
                            @"Roads\Highway2L\Textures\Ground_LOD__XYSMap.png"));
                    info.SetAllNodesTexture(
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Ground_Elevated_Node__MainTex.png",
                ...
                case NetInfoVersion.Bridge:
                    info.SetAllSegmentsTexture(
                        new TexturesSet(
                            @"Roads\Highway2L\Textures\Ground_Elevated_Segment__MainTex.png",
                            @"Roads\Highway2L\Textures\Elevated_Segment__APRMap.png"),
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Elevated_SegmentLOD__MainTex.png",
                            @"Roads\Highway2L\Textures\Elevated_SegmentLOD__APRMap.png",
                            @"Roads\Highway2L\Textures\Elevated_NodeLOD__XYSMap.png"));
                    info.SetAllNodesTexture(
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Ground_Elevated_Node__MainTex.png",
                            @"Roads\Highway2L\Textures\Elevated_Node__APRMap.png"),
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Elevated_NodeLOD__MainTex.png",
                            @"Roads\Highway2L\Textures\Elevated_NodeLOD__APRMap.png",
                            @"Roads\Highway2L\Textures\Elevated_NodeLOD__XYSMap.png"));
                    break;
                ...
                case NetInfoVersion.Slope:
                    info.SetAllSegmentsTexture(
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Slope_Segment__MainTex.png",
                ...
                case NetInfoVersion.Tunnel:
                    info.SetAllSegmentsTexture(
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Tunnel_Segment__MainTex.png",
                            @"Roads\Highway2L\Textures\Tunnel__APRMap.png"),
                    new TexturesSet
                       (@"Roads\Highway2L\Textures\Tunnel_SegmentLOD__MainTex.png",
                        @"Roads\Highway2L\Textures\TunnelLOD__APRMap.png",
                        @"Roads\Highway2L\Textures\Slope_NodeLOD__XYSMap.png"));
                    info.SetAllNodesTexture(
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Tunnel_Node__MainTex.png",
                            @"Roads\Highway2L\Textures\Tunnel__APRMap.png"),
                        new TexturesSet
                           (@"Roads\Highway2L\Textures\Tunnel_NodeLOD__MainTex.png",
                            @"Roads\Highway2L\Textures\TunnelLOD__APRMap.png",
                            @"Roads\Highway2L\Textures\Slope_NodeLOD__XYSMap.png"));
                    break;
            }
            ...
            if (version == NetInfoVersion.Tunnel)
            {
                ...
                if (leftHwLane != null)
                {
                    ...
                    newProps.name = "Highway2L Left Props";
                ...
                if (rightHwLane != null)
                {
                    ...
                    var newProps = ScriptableObject.CreateInstance<NetLaneProps>();
                    newProps.name = "Highway2L Right Props";
