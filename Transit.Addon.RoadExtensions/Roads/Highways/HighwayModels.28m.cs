...
namespace Transit.Addon.RoadExtensions.Roads.Highways
{
    ...
    {
        public static void Setup28mMesh(this NetInfo info, NetInfoVersion version)
        {
            ///////////////////////////
            // Template              //
            ///////////////////////////
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Ground.obj",
                     @"Roads\Highways\Meshes\28m\Ground_LOD.obj");

                nodes0.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Ground_Node.obj",
                     @"Roads\Highways\Meshes\28m\Ground_Node_LOD.obj");

                nodes1.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Ground_Trans.obj",
                     @"Roads\Highways\Meshes\28m\Ground_Trans_LOD.obj");
            ...
            else if (version == NetInfoVersion.Elevated)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Elevated.obj",
                    @"Roads\Highways\Meshes\28m\Elevated_LOD.obj");

                nodes0.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Elevated_Node.obj",
                    @"Roads\Highways\Meshes\28m\Elevated_Node_LOD.obj");

                nodes1.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Elevated_Trans.obj",
                    @"Roads\Highways\Meshes\28m\Elevated_Trans_LOD.obj");
            ...
            else if (version == NetInfoVersion.Slope)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Tunnel_Gray.obj",
                     @"Roads\Highways\Meshes\32m\Ground_LOD.obj");
                segments2.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Tunnel_Node_Gray.obj",
                     @"Roads\Highways\Meshes\32m\Slope_LOD.obj");

                nodes0.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Tunnel_Node_Gray.obj",
                     @"Roads\Highways\Meshes\32m\Ground_Node_LOD.obj");
                nodes1.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Ground_Node.obj",
                    @"Roads\Highways\Meshes\32m\Ground_Node_LOD.obj");
                nodes2.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Slope_U_Node.obj");
                nodes3.SetMeshes
                    (@"Roads\Highways\Meshes\32m\Ground_Trans.obj",
                     @"Roads\Highways\Meshes\32m\Ground_Trans_LOD.obj");
            ...
            else if (version == NetInfoVersion.Tunnel)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Tunnel_Gray.obj",
                    @"Roads\Highways\Meshes\28m\Ground_LOD.obj");
                segments1.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Tunnel.obj",
                    @"Roads\Highways\Meshes\28m\Tunnel_LOD.obj");
                nodes0.SetMeshes
                     (@"Roads\Highways\Meshes\28m\Tunnel_Node_Gray.obj",
                    @"Roads\Highways\Meshes\28m\Ground_Node_LOD.obj");
                nodes1.SetMeshes
                    (@"Roads\Highways\Meshes\28m\Tunnel_Node.obj",
                     @"Roads\Highways\Meshes\28m\Tunnel_Node_LOD.obj");
                // nodes2.SetMeshes
                //    (@"Roads\Highways\Meshes\28m\Tunnel.obj",
                //    @"Roads\Highways\Meshes\28m\Ground_LOD.obj");
