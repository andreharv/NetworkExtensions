	...
	public class LargeAvenue6LMBuilder : NetInfoBuilderBase, INetInfoBuilder
    {
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\LargeAvenue6LM\Meshes\Ground.obj");
            ...
            switch (version)
            {
                case NetInfoVersion.Ground:
                    info.SetAllSegmentsTexture(
                        new TexturesSet
                           (@"Roads\LargeAvenue6LM\Textures\Ground_Segment__MainTex.png",
                            @"Roads\LargeAvenue6LM\Textures\Ground_Segment__AlphaMap.png"));
                    break;
            }
