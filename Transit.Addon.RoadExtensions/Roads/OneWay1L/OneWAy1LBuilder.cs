...
namespace Transit.Addon.RoadExtensions.Roads.OneWay1L
{
    public class OneWay1LBuilder : NetInfoBuilderBase, INetInfoBuilder
    {
        ...
        public string ThumbnailsPath { get { return @"Roads\OneWay1L\thumbnails.png"; } }
        public string InfoTooltipPath { get { return @"Roads\OneWay1L\infotooltip.png"; } }
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                segments0.SetMeshes
                    (@"Roads\OneWay1L\Meshes\Ground.obj",
                     @"Roads\OneWay1L\Meshes\Ground_LOD.obj");
            ...
            switch (version)
            {
                case NetInfoVersion.Ground:
                    info.SetAllSegmentsTexture(
                        new TexturesSet
                           (@"Roads\OneWay1L\Textures\Ground_Segment__MainTex.png",
                            @"Roads\OneWay1L\Textures\Ground_Segment__AlphaMap.png"),
                        new TexturesSet
                           (@"Roads\OneWay1L\Textures\Ground_SegmentLOD__MainTex.png",
                            @"Roads\OneWay1L\Textures\Ground_SegmentLOD__AlphaMap.png",
                            @"Roads\OneWay1L\Textures\Ground_SegmentLOD__XYSMap.png"));
                    info.SetAllNodesTexture(
                        new TexturesSet
                            (@"Roads\OneWay1L\Textures\Ground_Node__MainTex.png",
                             @"Roads\OneWay1L\Textures\Ground_Node__AlphaMap.png"),
                        new TexturesSet
                            (@"Roads\OneWay1L\Textures\Ground_NodeLOD__MainTex.png",
                             @"Roads\OneWay1L\Textures\Ground_NodeLOD__AlphaMap.png",
                             @"Roads\OneWay1L\Textures\Ground_NodeLOD__XYSMap.png"));
                    break;
            }
