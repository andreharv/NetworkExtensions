                ...
                case NetInfoVersion.Slope:
                    {
                        ...
                        segment2
                            .SetFlagsDefault()
                            .SetMeshes
                            (@"Roads\Roads\Meshes\16m\3mSW\Slope.obj",
                            @"Roads\Roads\Meshes\16m\3mSW\Slope_LOD.obj");

                        node1
                            .SetMeshes
                            (@"Roads\Roads\Meshes\16m\3mSW\Slope_Node.obj",
                            @"Roads\Roads\Meshes\16m\3mSW\Slope_Node_LOD.obj");

                        node2
                            .SetFlags(NetNode.Flags.Underground, NetNode.Flags.None)
                            .SetMeshes
                            (@"Roads\Roads\Meshes\16m\3mSW\Slope_U_Node.obj",
                            @"Roads\Roads\Meshes\16m\3mSW\Slope_U_Node_LOD.obj");
                ...
                case NetInfoVersion.Tunnel:
                    {
                        ...
                        segment1
                            .SetFlagsDefault()
                            .SetMeshes
                            (@"Roads\Roads\Meshes\16m\3mSW\Tunnel.obj",
                            @"Roads\Roads\Meshes\16m\3mSW\Tunnel_LOD.obj");

                        node1
                            .SetFlags(NetNode.Flags.None,NetNode.Flags.None)
                            .SetMeshes
                            (@"Roads\Roads\Meshes\16m\3mSW\Tunnel_Node.obj",
                            @"Roads\Roads\Meshes\16m\3mSW\Tunnel_Node_LOD.obj");
