...
namespace TransitPlus.Addon.RoadExtensions.Roads.SmallHeavyRoads.OneWay3LParking
{
    public partial class OneWay3LParkingBuilder
    {
            ...
            switch (version)
            {
                case NetInfoVersion.Ground:
                    info.SetAllSegmentsTexture(
                        new TextureSet
                            (@"Roads\SmallHeavyRoads\OneWay3LParking\Textures\Ground_Segment__MainTex.png",
                            @"Roads\SmallHeavyRoads\OneWay3LParking\Textures\Ground_Segment__AlphaMap.png"),
                        new LODTextureSet
                            (@"Roads\SmallHeavyRoads\OneWay3LParking\Textures\Ground_SegmentLOD__MainTex.png",
                            @"Roads\SmallHeavyRoads\OneWay3LParking\Textures\Ground_SegmentLOD__AlphaMap.png",
                            @"Roads\SmallHeavyRoads\OneWay3LParking\Textures\Ground_SegmentLOD__XYS.png"));
                    break;
