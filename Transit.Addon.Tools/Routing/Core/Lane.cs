...
namespace Transit.Addon.Tools.Core
{
    ...
    public class Lane
    {
        ...
        public TAMVehicleType m_vehicleTypes = TAMVehicleType.All;
        ...
        void SetDefaultArrows(ushort seg, ref NetSegment segment)
        {
            ...
            {
                if (laneId != m_laneId && LanesManager.instance.sm_lanes[laneId] != null && LanesManager.instance.sm_lanes[laneId].ConnectionCount() > 0)
                    LanesManager.instance.sm_lanes[laneId].UpdateArrows();
