...
namespace Transit.Addon.ToolsV2.LaneRouting.Core
{
    class NetInfoLane : NetInfo.Lane
    {
        ...
        public TPPVehicleType m_allowedVehicleTypes;
        public SpecialLaneType m_specialLaneType;


        public NetInfoLane(TPPVehicleType vehicleTypes, SpecialLaneType specialLaneType = SpecialLaneType.None)
        {
            this.m_allowedVehicleTypes = vehicleTypes;
            this.m_specialLaneType = specialLaneType;
        }

        public NetInfoLane(NetInfo.Lane lane, SpecialLaneType specialLaneType = SpecialLaneType.None) : this(lane, TPPVehicleType.All, specialLaneType) { }

        public NetInfoLane(NetInfo.Lane lane, TPPVehicleType vehicleTypes, SpecialLaneType specialLaneType = SpecialLaneType.None) : this(vehicleTypes, specialLaneType)
        {
            CopyAttributes(lane);
        }
