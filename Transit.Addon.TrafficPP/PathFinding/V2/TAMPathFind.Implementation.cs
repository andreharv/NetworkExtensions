...
{
    public partial class TAMPathFind
    {
        private void PathFindImplementation(uint unit, ref PathUnit data)
        {
            ...
            {
                this.m_startLaneA = TAMPathManager.GetLaneID(data.m_position00);
            ...
            {
                this.m_startLaneB = TAMPathManager.GetLaneID(data.m_position02);
            ...
            {
                this.m_endLaneA = TAMPathManager.GetLaneID(data.m_position01);
            ...
            {
                this.m_endLaneB = TAMPathManager.GetLaneID(data.m_position03);
            ...
            {
                this.m_vehicleLane = TAMPathManager.GetLaneID(data.m_position11);
            ...
            for (int k = 0; k < 262144; k++)
            {
                ...
                if (num10 == 12)
                {
                    ...
                    try
                    {
                        ...
                        this.m_pathUnits.m_buffer[(int)((UIntPtr)num9)].m_positionCount = (byte)num10;
                        num11 += num10;
                        Singleton<TAMPathManager>.instance.m_pathUnitCount = (int)(this.m_pathUnits.ItemCount() - 1u);
                    }
                    finally
                    {
                ...
                uint laneID = TAMPathManager.GetLaneID(position);
