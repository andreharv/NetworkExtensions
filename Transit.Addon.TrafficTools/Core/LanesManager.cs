...
namespace Transit.Addon.TrafficTools.Core
{
    public static class LanesManager
    {
        ...
        public static bool CanUseLane(TAMVehicleType vehicleType, uint laneId)
        {            
            return (GetLane(laneId).m_vehicleTypes & vehicleType) != TAMVehicleType.None;
        }

        public static TAMVehicleType GetVehicleRestrictions(uint laneId)
        {
            return GetLane(laneId).m_vehicleTypes;
        }

        public static void SetVehicleRestrictions(uint laneId, TAMVehicleType vehicleRestrictions)
        {
            GetLane(laneId).m_vehicleTypes = vehicleRestrictions;
        }

        public static void ToggleVehicleRestriction(uint laneId, TAMVehicleType vehicleType)
        {
