...
{
    public class TransportLineAIHook : TransportLineAI
    {
        [RedirectFrom(typeof(TransportLineAI), (ulong)PrerequisiteType.PathFinding)]
        ...
        [RedirectTo(typeof(TransportLineAI), (ulong)PrerequisiteType.PathFinding)]
